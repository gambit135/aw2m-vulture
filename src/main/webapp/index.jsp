...
<html>
  <head>
    <meta charset="utf-8">
    <title>My Spring MVC and Hibernate Template</title>
      ...
      <div class="row">
        <div class="span8 offset2">
          ...
          <div style="margin-bottom: 20px">
            This is a template for a web application that uses Spring MVC and Hibernate. The sample code is a simple CRUD page that manipulates records for a single model object. To try it out go to the <a href="/musicalArtist/">musicalArtist page</a>. Then use Eclipse or the Command Line to deploy some changes. 
          </div>
        ...
        <div class="tab-content">
          ...
          <div id="eclipse-instructions" class="instructions tab-pane active">
            ...
            <h2>Step 4. Makes some changes to the application</h2>
            <ol>
