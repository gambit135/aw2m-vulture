 ...
 * @author Jose
 */
public class MyPelletReasoner {

    public static final String DOCUMENT_IRI = "https://dl.dropbox.com/u/20278793/ontology/Groove/Groove.owl";
//    public static final String DOCUMENT_IRI = "https://dl.dropbox.com/u/20278793/ontology/Groove/Groove.owl&format=RDF/XML";

    public static void main(String[] args) {

        try {
            // Create our ontology manager in the usual way.
            //Descomentar desde aki para leerla en linea
...
//            OWLOntologyManager manager = OWLManager.createOWLOntologyManager();
//        File file = new File("E:\\Administrador\\Mis Cosas\\Dropbox\\TT\\Ontologías\\MO1.owl");
...
//             OWLReasonerFactory reasonerFactory = null;
            ...
            // Get a reference to the vegetarian class so that we can ask the reasoner about it.
          ...
          NodeSet<OWLClass> subClses = reasoner.getSubClasses(vegPizza, true);
           ...
           OWLClass pet = fac.getOWLClass(IRI.create("http://owl.man.ac.uk/2005/07/sssw/people#pet"));
            // Ask the reasoner for the instances of pet
            NodeSet<OWLNamedIndividual> individualsNodeSet = reasoner.getInstances(pet, true);
            ...
            OWLNamedIndividual rsu = fac.getOWLNamedIndividual(IRI.create("http://www.semanticweb.org/ontologies/2011/10/RSU.owl#tipoA"));
//            System.out.println("Clases de minnie");
//            Set <OWLClassExpression> clasesMick = mick.getTypes(ont);
//            for(OWLClassExpression mi:clasesMick){
...
//            }
            ...
            OWLObjectProperty fuera = fac.getOWLObjectProperty(IRI.create("http://www.semanticweb.org/ontologies/2011/10/RSU.owl#fuera"));

            // Now ask the reasoner for the has_pet property values for Mick
            NodeSet<OWLNamedIndividual> petValuesNodeSet = reasoner.getObjectPropertyValues(rsu, fuera);
            Set<OWLNamedIndividual> values = petValuesNodeSet.getFlattened();
            System.out.println("Estan fuera de un RSU tipo A: ");
