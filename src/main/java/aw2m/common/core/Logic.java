...
public class Logic {
     ...
     * @param map            - The map
     * @param u              - The indirect unit of whom the killzone wants to be known.
...
//					+ defender.currentHP);
    ...
    private static void startAStar(GridCell location, byte movement) {
        ...
        do {
            ...
            DijkstraElement temp = openList.getFirst();
        ...
        if (location.y > 0) { // Not on the upper border of the map
            ...
            if (Logic.map[location.x][location.y - 1].terrain
                ...
                if (center.movementPointsLeft
                    ...
                    if (checkIfShouldReplaceOldForNewDijkstraOnClosedList(d)) return;
                    checkIfShouldReplaceOldForNewDijkstraOnOpenList(d);
    ...
    private static boolean checkIfShouldReplaceOldForNewDijkstraOnClosedList(DijkstraElement d) {
        if (Logic.closedList.contains(d)) {
            ...
            } else {    // Already on closed List. New not better than old
                return true;
            }
        }
        return false;
    ...
    private static void checkIfShouldReplaceOldForNewDijkstraOnOpenList(DijkstraElement d) {
        ...
        } else Logic.pendingOpenList.add(d);
    }
