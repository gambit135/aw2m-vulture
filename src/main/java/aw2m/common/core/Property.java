 ...
 * types for all players on all the map, such as which unit class can repair.
 * Property objects are referenced by a GridCell object. Note that there will be
 * at most, five objects created from this class at a time on each map.
 *
...
public class Property {
    ...
    /**
     * Returns a Singleton reference to a Property object, holding the common
     * characteristics of one of the five properties available in the game: HQ,
     * City, Base, Airport and Port.
     *
     * @param propertyType
     * @return A new Property object representing the characteristics of one of
     *         the five properties on the game, if none exists; or a newly
     ...
     * same time: e.g., before capturing the lab maps, you can't deploy
     * Neotanks.
     *
     * @param propertyType
     * @return
