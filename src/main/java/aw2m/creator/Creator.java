...
public class Creator {
     ...
     * deployed on a GridCell of the Mapboard.
     */
    ...
    public void createAbstractMap(byte x, byte y) {
        ...
        map.setPlayer1(Player.getGenericPlayer());
        map.setPlayer2(Player.getGenericPlayer());
    }
     ...
     * the terrain is defined on the Terrain class. The objects associated to
     * each GridCell object follow the Singleton pattern and, therefore, two
     * distinct GridCell objects may share a reference to the same Terrain
     * objet. See the Terrain class documentation.
     *
