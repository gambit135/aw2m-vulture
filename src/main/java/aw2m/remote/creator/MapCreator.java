...
/**
 * Its function is to create or generate maps for testing/playing.
 *
...
public class MapCreator {
    ...
    /**
     * The map that this MapCreator object will initialize and modify to deliver
     * an initial state of a game, ready to be played.
     */
    Map map;
    ...
    /**
     * Fills the entire mapboard contained on the current Map of the MapCreator
